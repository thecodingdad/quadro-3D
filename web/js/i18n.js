...
const de = {
  ...
  quality_high: 'Hoch',
  // Onboarding-Demo (tour.js): je Schritt Titel und Text
  settings_tour: 'Einführung',
  btn_tour: 'Demo starten',
  tour_next: 'Weiter',
  tour_back: 'Zurück',
  ...
  tour_step: (i, n) => `${i} / ${n}`,
  tour_demo_name: 'Demo',
  tour_welcome_title: 'Willkommen bei QUADRO 3D',
  tour_welcome_text: 'Ein kurzer Rundgang zeigt dir, wo was liegt. Zum Ausprobieren steht ein kleines Beispielmodell bereit – dein eigener Stand bleibt unberührt. Überspringen kannst du jederzeit.',
  tour_file_title: 'Datei',
  tour_file_text: 'Neu, Öffnen, Speichern, Import und Export von QDF-Dateien der QUADRO-Software. Modelle liegen im Browser; mit Server werden sie zwischen deinen Geräten abgeglichen.',
  // Bei enger Kopfzeile stehen diese Einträge im Hauptmenü (☰ oben rechts).
  tour_file_text_mobile: 'Im Hauptmenü: Neu, Öffnen, Speichern, Import und Export von QDF-Dateien der QUADRO-Software. Modelle liegen im Browser; mit Server werden sie zwischen deinen Geräten abgeglichen.',
  tour_undo_title: 'Rückgängig und Speichern',
  tour_undo_text: 'Jeder Schritt lässt sich zurücknehmen (Strg+Z) und wiederholen (Strg+Y). Daneben steht der Schalter fürs automatische Speichern – er ist von Haus aus an.',
  tour_undo_text_mobile: 'Jeder Schritt lässt sich zurücknehmen und wiederholen. Der Schalter fürs automatische Speichern steht im Hauptmenü und ist von Haus aus an.',
  tour_parts_title: 'Bauteile',
  tour_parts_text: 'Hier wählst du, was du setzt: Rohre, Platten, Rutschen, Verbindungen und Verstärkungen. Der Cursor (S) wählt vorhandene Teile aus, das Kreuz löscht sie.',
  tour_parts_text_mobile: 'Diese Leiste am unteren Rand hält alles, was du setzen kannst: Rohre, Platten, Rutschen, Verbindungen und Verstärkungen. Sie lässt sich seitwärts schieben. Der Cursor wählt vorhandene Teile aus, das Kreuz löscht sie.',
  tour_color_title: 'Farbe',
  tour_color_text: 'Die Farbe gilt für alles, was du als Nächstes setzt. Ein Klick auf ein vorhandenes Teil im Cursor-Modus färbt es um.',
  tour_color_text_mobile: 'Der Farbtupfer klappt die Farbreihe auf. Die Farbe gilt für alles, was du als Nächstes setzt; ein Tipp auf ein vorhandenes Teil im Cursor-Modus färbt es um.',
  tour_canvas_title: 'Die Szene',
  tour_canvas_text: 'Ziehen dreht die Ansicht, das Mausrad zoomt, zwei Finger verschieben. Im Bau-Modus zeigen grüne Punkte, wo das gewählte Teil hinpasst – ein Klick setzt es.',
  tour_canvas_text_mobile: 'Ein Finger dreht die Ansicht, zwei Finger zoomen und verschieben. Im Bau-Modus zeigen grüne Punkte, wo das gewählte Teil hinpasst – ein Tipp setzt es.',
  tour_canvas_tools_title: 'Raster und Tastenkürzel',
  tour_canvas_tools_text: 'Hier stellst du die Schrittweite fürs Verschieben ein (5 bis 80 cm) und öffnest die Liste aller Tastenkürzel – die geht auch mit F1 auf.',
  // Die Tastenkürzel-Liste gibt es auf schmalen Schirmen nicht (kein Keyboard).
  tour_canvas_tools_title_mobile: 'Rasterweite',
  tour_canvas_tools_text_mobile: 'Hier stellst du die Schrittweite fürs Verschieben ein: 5 bis 80 cm. Sie gilt fürs Ziehen einer Auswahl und fürs Einfügen.',
  tour_scene_title: 'Wiese und Himmel',
  tour_scene_text: 'Dieser Schalter stellt das Gerüst in eine Umgebung: Gras, Bäume, Himmel und Schatten – gut für einen Eindruck, wie es im Garten aussieht.',
  tour_view_title: 'Ansicht',
  tour_view_text: 'Die Schnittebene blendet alles vor einer Ebene aus – gut, um ins Modell zu sehen. Daneben wechselst du zwischen Perspektive und orthogonaler Ansicht.',
  tour_tabs_title: 'Mehrere Modelle',
  tour_tabs_text: 'Jedes offene Modell hat seinen eigenen Tab, wie im Browser. Ungespeichertes übersteht das Neuladen der Seite.',
  tour_sidebar_title: 'Stückliste, Modelle, Bibliothek',
  tour_sidebar_text: 'Die Stückliste zählt Rohre, Kupplungen, Platten und Schrauben mit Preis und vergleicht sie mit deinem Bestand. Daneben liegen deine Modelle und die eingelesene QDF-Sammlung.',
  tour_assembly_title: 'Bauen und Aufbau',
  tour_assembly_text: 'Zwei Betriebsarten: „Bauen“ (B) verändert das Modell – Rohre, Platten, Rutschen, Farben. „Aufbau“ (A) zerlegt das fertige Gerüst Lage für Lage in Bauschritte: je Schritt die Teile, die dazukommen, das Fertige bleibt blass stehen.',
  tour_assembly_text_mobile: 'Zwei Betriebsarten, hier im Hauptmenü: „Bauen“ verändert das Modell – Rohre, Platten, Rutschen, Farben. „Aufbau“ zerlegt das fertige Gerüst Lage für Lage in Bauschritte: je Schritt die Teile, die dazukommen, das Fertige bleibt blass stehen.',
  tour_assembly_panel_title: 'Der Bauplan',
  tour_assembly_panel_text: 'Rechts steht jetzt der Aufbau-Bereich: mit ‹ und › oder den Pfeiltasten gehst du durch die Schritte, darunter stehen die Teile des jeweiligen Schritts. Reihenfolge und Farbbehandlung stellst du oben ein.',
  tour_assembly_sheet_title: 'Der Bauplan',
  tour_assembly_sheet_text: 'Unten liegt jetzt die Aufbau-Karte: mit ‹ und › gehst du durch die Schritte, darunter stehen die Teile des jeweiligen Schritts. Am Griff ziehst du die Karte größer oder wieder zu.',
  tour_settings_title: 'Einstellungen',
  tour_settings_text: 'Sprache, Erscheinungsbild und Render-Qualität. Diesen Rundgang startest du hier jederzeit erneut.',
  ...
  btn_grid_title: 'Rasterweite beim Verschieben',
  grid_step: (cm) => `${cm} cm`,
  btn_help: '⌨ Tasten',
  ...
  btn_lib_copy: 'In die Bibliothek kopieren',
  btn_lib_delete: 'Aus der Bibliothek entfernen',
  confirm_delete_lib: (name) => `„${name}" aus der Bibliothek entfernen?`,
  dlg_lib_copy_title: 'In die Bibliothek kopieren',
  dlg_lib_copy_text: (name) => `„${name}" als Kopie in die Bibliothek legen. Unter „Meine Modelle" bleibt es stehen.`,
  dlg_lib_copy_ok: 'Kopieren',
  flash_lib_copied: (name) => `„${name}" liegt jetzt in der Bibliothek.`,
  lib_copy_failed: 'Kopieren in die Bibliothek fehlgeschlagen.',
  lib_search: 'Suchen…',
  aria_menu: 'Menü',
  ...
  help_groups: [
    ...
    ['Auswahl', [
      ['Pfeiltasten', 'Auswahl verschieben – Schrittweite unten rechts im Bild'],
  ...
  status_c45: 'Winkelkupplung: die äußeren Punkte setzen sie auf einen Stutzen der Kupplung. Der große Punkt MITTEN auf einer Dummy-Kupplung steckt sie direkt ins Rohr – sie ersetzt die Kupplung, am anderen Ende der Hülse entsteht eine neue. Ein Klick auf eine Kupplung zeigt nur noch deren Punkte, ein Klick auf die gesetzte Winkelkupplung dreht sie um 90°.',
  notice_c45_click_arm: 'Auf einen grünen Punkt klicken – außen an einem Stutzen oder mittig auf einer Dummy-Kupplung.',
  ...
  status_clamp: 'Doppelrohrverbinder / Rohrklammer: auf ein Rohr klicken – der Punkt folgt dem Zeiger, die Klickseite gibt vor, wohin das zweite Loch zeigt. Ein Klick auf eine gesetzte Klemme dreht sie um 45° weiter; gelöscht wird im Auswahl-Modus.',
  bom_wheels: 'Räder',
  ...
  inv_have: (need, owned) => `Benötigt: ${need} · vorhanden: ${owned}`,
  ...
  btn_doc_close_all: 'Alle schließen',
  ...
  // Je Teileart ein eigener Hinweis -- die Ankerpunkte liegen sehr verschieden:
  // an einem Stutzen, frei auf einem Rohr, am Rohrende oder zwischen zwei Rohren.
  status_fitting_arm: 'Stutzen-Teil: auf einen grünen Punkt an einer Kupplung klicken. Ein Klick auf das gesetzte Teil dreht es auf den nächsten freien Stutzen.',
  status_fitting_arm_fixed: 'Stutzen-Teil: auf einen grünen Punkt an einer Kupplung klicken. Es sitzt dann fest – gelöscht wird im Auswahl-Modus.',
  status_fitting_tube: 'Rohr-Teil: einen grünen Punkt anklicken – er wandert unter dem Zeiger am Rohr entlang, dort sitzt das Teil dann.',
  ...
  status_fitting_round: 'Rundwand: auf einen Punkt zwischen zwei Bogenrohren klicken – sie spannt sich über beide.',
  status_slide: 'Rutsche: ein hervorgehobenes Feld anklicken – sie fällt zu der Seite ab, von der aus man daraufschaut. Der Einstieg braucht zwei senkrechte 15er Rohre mit einem 35er darunter (dort wird sie verschraubt). Am freien Ausgang eines gesetzten Teils geht die Kette weiter.',
  status_slide_solo: 'Rutsche: ein hervorgehobenes Feld zwischen zwei Rohren anklicken – sie fällt zu der Seite ab, von der aus man daraufschaut. Ein Folgeteil nimmt sie nicht auf.',
...
const en = {
  ...
  quality_high: 'High',
  // Onboarding tour (tour.js): title and text per step
  settings_tour: 'Introduction',
  btn_tour: 'Start tour',
  tour_next: 'Next',
  tour_back: 'Back',
  tour_skip: 'Skip',
  ...
  tour_step: (i, n) => `${i} / ${n}`,
  tour_demo_name: 'Demo',
  tour_welcome_title: 'Welcome to QUADRO 3D',
  tour_welcome_text: 'A short tour shows you where everything is. A small example model is ready to play with – your own work stays untouched. You can skip at any time.',
  tour_file_title: 'File',
  tour_file_text: 'New, open, save, plus import and export of QDF files from the QUADRO software. Models live in the browser; with a server they sync between your devices.',
  // With a narrow header these entries live in the main menu (☰, top right).
  tour_file_text_mobile: 'In the main menu: new, open, save, plus import and export of QDF files from the QUADRO software. Models live in the browser; with a server they sync between your devices.',
  tour_undo_title: 'Undo and saving',
  tour_undo_text: 'Every step can be undone (Ctrl+Z) and redone (Ctrl+Y). Next to it is the switch for saving automatically – on by default.',
  tour_undo_text_mobile: 'Every step can be undone and redone. The switch for saving automatically sits in the main menu and is on by default.',
  tour_parts_title: 'Parts',
  tour_parts_text: 'Pick what you place here: tubes, panels, slides, connectors and reinforcements. The cursor (S) selects existing parts, the cross deletes them.',
  tour_parts_text_mobile: 'This row along the bottom holds everything you can place: tubes, panels, slides, connectors and reinforcements. It scrolls sideways. The cursor selects existing parts, the cross deletes them.',
  tour_color_title: 'Colour',
  tour_color_text: 'The colour applies to everything you place next. In cursor mode, clicking an existing part recolours it.',
  tour_color_text_mobile: 'The swatch opens the colour row. The colour applies to everything you place next; tapping an existing part in cursor mode recolours it.',
  tour_canvas_title: 'The scene',
  tour_canvas_text: 'Drag to orbit, scroll to zoom, two fingers to pan. In build mode the green dots show where the selected part fits – one click places it.',
  tour_canvas_text_mobile: 'One finger orbits, two fingers zoom and pan. In build mode the green dots show where the selected part fits – one tap places it.',
  tour_canvas_tools_title: 'Grid and shortcuts',
  tour_canvas_tools_text: 'Here you set the step size for moving (5 to 80 cm) and open the list of all keyboard shortcuts – F1 opens it as well.',
  // The shortcut list is not shown on narrow screens (no keyboard).
  tour_canvas_tools_title_mobile: 'Grid size',
  tour_canvas_tools_text_mobile: 'Here you set the step size for moving: 5 to 80 cm. It applies to dragging a selection and to pasting.',
  tour_scene_title: 'Grass and sky',
  tour_scene_text: 'This switch puts the frame into a setting: grass, trees, sky and shadows – a good impression of how it will look in the garden.',
  tour_view_title: 'View',
  tour_view_text: 'The clipping plane hides everything in front of a plane – handy for looking inside. Next to it you switch between perspective and orthographic view.',
  tour_tabs_title: 'Several models',
  tour_tabs_text: 'Every open model has its own tab, like in a browser. Unsaved work survives a page reload.',
  tour_sidebar_title: 'Parts list, models, library',
  tour_sidebar_text: 'The parts list counts tubes, connectors, panels and screws with prices and compares them with your stock. Next to it are your models and the imported QDF collection.',
  tour_assembly_title: 'Build and assembly',
  tour_assembly_text: 'Two modes: “Build” (B) changes the model – tubes, panels, slides, colours. “Assembly” (A) breaks the finished frame into layers: each step shows the parts that are added, what is done stays faded.',
  tour_assembly_text_mobile: 'Two modes, here in the main menu: “Build” changes the model – tubes, panels, slides, colours. “Assembly” breaks the finished frame into layers: each step shows the parts that are added, what is done stays faded.',
  tour_assembly_panel_title: 'The build plan',
  tour_assembly_panel_text: 'The assembly area is now on the right: step through the plan with ‹ and › or the arrow keys, the parts of each step are listed below. Order and colour handling are set at the top.',
  tour_assembly_sheet_title: 'The build plan',
  tour_assembly_sheet_text: 'The assembly card is now at the bottom: step through the plan with ‹ and ›, the parts of each step are listed below. Drag the handle to enlarge the card or close it again.',
  tour_settings_title: 'Settings',
  tour_settings_text: 'Language, appearance and render quality. You can restart this tour here at any time.',
  ...
  btn_grid_title: 'Grid step when moving',
  grid_step: (cm) => `${cm} cm`,
  btn_help: '⌨ Keys',
  ...
  btn_lib_copy: 'Copy to library',
  btn_lib_delete: 'Remove from the library',
  confirm_delete_lib: (name) => `Remove “${name}” from the library?`,
  dlg_lib_copy_title: 'Copy to library',
  dlg_lib_copy_text: (name) => `Put a copy of “${name}” into the library. It stays under “My models”.`,
  dlg_lib_copy_ok: 'Copy',
  flash_lib_copied: (name) => `“${name}” is in the library now.`,
  lib_copy_failed: 'Copying to the library failed.',
  lib_search: 'Search…',
  aria_menu: 'Menu',
  ...
  help_groups: [
    ...
    ['Selection', [
      ['Arrow keys', 'Move selection – step size set bottom right'],
  ...
  status_c45: 'Angle connector: the outer dots put it onto a stub of the connector. The big dot in the MIDDLE of a dummy connector plugs it straight into the tube – it replaces that connector, and a new one appears at the other end of the sleeve. Clicking a connector shows only its dots, clicking the placed angle connector turns it by 90°.',
  notice_c45_click_arm: 'Click a green dot – outside at a stub, or in the middle of a dummy connector.',
  ...
  status_clamp: 'Double tube connector / tube clamp: click a tube – the dot follows the pointer, and the side you click decides where the second hole points. Clicking a placed clamp turns it by 45°; delete it in select mode.',
  bom_wheels: 'Wheels',
  ...
  inv_have: (need, owned) => `Needed: ${need} · in stock: ${owned}`,
  ...
  status_fitting_arm: 'Stub part: click a green dot at a connector. Clicking the placed part moves it on to the next free stub.',
  status_fitting_arm_fixed: 'Stub part: click a green dot at a connector. It sits fixed there – delete it in select mode.',
  status_fitting_tube: 'Tube part: click a green dot – it follows the pointer along the tube, and that is where the part goes.',
  ...
  status_fitting_round: 'Curved wall: click a dot between two curved tubes – it spans both.',
  status_slide: 'Slide: click a highlighted field – it falls towards the side you are looking from. The entry needs two upright 15 cm tubes with a 35 cm one below them (that is where it is bolted on). A placed part continues the chain at its free exit.',
  status_slide_solo: 'Slide: click a highlighted field between two tubes – it falls towards the side you are looking from. Nothing chains onto it.',
