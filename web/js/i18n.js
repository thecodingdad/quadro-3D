...
const de = {
  ...
  status_fitting_hinge: 'Flexikupplung Scharnier: auf das mittlere Segment eines Bolzens, höchstens zwei je Bolzen. Ein Klick auf das gesetzte dreht es um 45° weiter – solange kein Rohr daran hängt; die beiden Scharniere bleiben dabei mindestens 45° auseinander.',
  ...
  status_slide: 'Rutsche: ein hervorgehobenes Feld zwischen zwei Rohren anklicken – sie fällt zu der Seite ab, von der aus man daraufschaut. Am freien Ausgang eines gesetzten Teils geht die Kette weiter.',
...
const en = {
  ...
  status_fitting_hinge: 'Flexi connector hinge: onto the middle segment of a bolt, at most two per bolt. Clicking the placed one turns it by 45° – as long as no tube hangs on it; the two hinges always stay at least 45° apart.',
  ...
  status_slide: 'Slide: click a highlighted field between two tubes – it falls towards the side you are looking from. A placed part continues the chain at its free exit.',
